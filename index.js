...
const uri = `mongodb+srv://${process.env.DB_USER}:${process.env.DB_PASS}@cluster0.tlrxmsc.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0`;
...
app.get('/',(req,res)=>{ 
    res.send('Tourism Mangement website')

}) 

app.listen(port,()=>{ 

    console.log(`Tourism Mangement Website is Running  ${port}`)
